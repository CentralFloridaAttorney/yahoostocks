...
1) get_financial_stmts(frequency, statement_type, reformat=True)
   ...
   - reformat optional value defaulted to true. Enter False for unprocessed raw options from Yahoo Finance.
...
6) get_historical_price_data(start_date, end_date, time_interval)
   - Gets historical price options for currencies, stocks, indexes, cryptocurrencies, and commodity futures.
...
# Class used to open urls for financial options
...
class YahooFinanceETL(object):
    ...
    # Meta-options dictionaries for the classes to use
    ...
    # Private method to scrape options from yahoo finance
    ...
    # Private static method to determine if a numerical value is in the options object being cleaned
    @staticmethod
    ...
    # Private method to process raw earnings options and clean
    ...
    # Private Method to clean the dates of the newly returns historical stock options into readable format
    ...
    # Private Method to get financial options via API Call
    ...
    # Private Method to clean API options
    ...
    # Private Method to take scrapped options and build a options dictionary with
    ...
    # Public Method to get stock options
    ...
    # Public Method to get technical stock options
    ...
    # Public Method to get reformatted statement options
    ...
    # Public method to get cleaned summary and price report options
    ...
    # Private method to handle dividend options requests
