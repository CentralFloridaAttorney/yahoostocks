    ...
    def history(self, period="1mo", interval="1d",
        ...
        :Parameters:
            ...
            interval : str
                ...
                Intraday options cannot extend last 60 days
            start: str
                ...
                Default is now
            prepost : bool
                Include Pre and Post market options in results?
                Default is False
            auto_adjust: bool
                Adjust all OHLC automatically? Default is True
            back_adjust: bool
                Back-adjusted options to mimic true historical prices
            proxy: str
            ...
            tz: str
                ...
                (default options is returned as non-localized dates)
            **kwargs: dict
                debug: bool
        ...
        err_msg = "No options found for this date range, symbol may be delisted"
        ...
        if not actions:
            df.drop_col(columns=["Dividends", "Stock Splits"], inplace=True)
